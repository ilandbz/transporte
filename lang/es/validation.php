...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña proporcionada se ha filtrado en una filtración de datos. Por favor, elija una contraseña diferente.',
    ],
    ...
    'attributes' => [
        ...
        'layout_asientos' => 'distribución de asientos',
        'name' => 'nombre',
        'email' => 'correo electrónico',
        'password' => 'contraseña',
        'role' => 'rol',
        'dni_pasajero' => 'DNI del pasajero',
        'nombre_pasajero' => 'nombre del pasajero',
        'telefono_pasajero' => 'teléfono del pasajero',
        'estado_pago' => 'estado de pago',
        'metodo_pago' => 'método de pago',
        'tipo_documento' => 'tipo de documento',
        'documento_facturacion' => 'documento de facturación',
        'nombre_facturacion' => 'nombre de facturación',
        'origen_tramo' => 'origen de tramo',
        'destino_tramo' => 'destino de tramo',
        'clase' => 'clase',
    ],
];
